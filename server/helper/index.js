...
let helper = {
    ...
    warn : function (msg) {
        console.warn('[' + moment().format('YYYY-MM-DD HH:mm:ss.SSS') + '] WARN:' + msg)
    },
    log : function (msg) {
        console.log('[' + moment().format('YYYY-MM-DD HH:mm:ss.SSS') + '] LOG:' + msg)
    },
    info : function (msg) {
        console.info('[' +  moment().format('YYYY-MM-DD HH:mm:ss.SSS') + '] INFO:' + msg)
    },
    error : function (msg) {
        console.error('[' +  moment().format('YYYY-MM-DD HH:mm:ss.SSS') + '] ERROR:' + msg)
    },
    ...
    makeImgFileInfo : function(){
        return helper.makeFileInfo('img','.png')
    },
